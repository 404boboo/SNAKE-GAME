 ...
 * For SFML2.
 * 
 * Reference: https://github.com/SFML/SFML/wiki/Source:-Simple-Collision-Detection-for-SFML-2
...
namespace Collision {
	...
	bool pixelCollideTest(const sf::RectangleShape shape, const sf::Sprite* sprite, sf::Uint8 alphaLimit = 0);
	...
	/// You can avoid this by using the "createTextureAndBitmask" function
	//////
    bool pixelCollideVector(const sf::Sprite* sprite, sf::Uint8* spriteMask, int blockSize, sf::Vector2f& mousePosition, float alphaLimit);
